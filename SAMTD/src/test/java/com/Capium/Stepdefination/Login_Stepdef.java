...
//	@When("Enter {string} and {string} in Respective fields")
//	public void enter_and_in_respective_fields(String betaUsername, String betaPassword) {
//		betaUsername = ConfigReader.getProperty("BetaUserName");
//		betaPassword = ConfigReader.getProperty("BetaPassword");
//		
//		//old login
//		//HelperClass.getDriver().findElement(By.xpath("//input[@id='txtusername']")).sendKeys(Username);
//		//HelperClass.getDriver().findElement(By.xpath("//input[@id='txtpassword']")).sendKeys(Password);
//		// Identity login
//		HelperClass.getDriver().findElement(By.xpath("//input[@name='Username']")).sendKeys(Username);
//		HelperClass.getDriver().findElement(By.xpath("//input[@name='Password']")).sendKeys(Password);
//	}
